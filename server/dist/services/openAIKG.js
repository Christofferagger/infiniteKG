        ...
        try {
            completion = yield openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "user",
                        content: `Help me understand this question: ${query}, by making a simple dense knowledge-graph. Use the provided answer as a reference but remember to make it simple and dense so it make sense in a knowledge Graph, you can produce a maximum of 8 relevant nodes and 12 relevant relationships. The knowledge graph should be a visual dense representation of the answer. Answer: ${answer}.`
                    }
                ],
                functions: [
                    {
